...
catalodList.push(new Item('Djay', ['./img/Image2.png', './img/Image3.png', './img/Image4.png'], 'Has a removable, fabric robe', 17));
catalodList.push(new Item('Zein', ['./img/Image3.png', './img/Image4.png', './img/Image5.png'], 'Individual sets of building', 15));
catalodList.push(new Item('Kai', ['./img/Image4.png', './img/Image5.png', './img/Image6.png'], 'Components are dropped', 32, 10));
catalodList.push(new Item('Master Voo', ['./img/Image5.png', './img/Image6.png', './img/Image1.png'], 'Models carry brick-built', 22));
catalodList.push(new Item('Mech', ['./img/Image6.png', './img/Image1.png', './img/Image2.png'], 'The perfect building toys for kids', 22, 10));
